        ...
        <div>
            <div className="min-h-screen min-w-screen h-full dark:bg-gray-800">
                ...
                <section className="container py-10 px-4 mx-auto">
                    <h1 className="text-slate-200 text-4xl font-semibold my-4">Peserta</h1>
                                        ...
                                        <tbody className="bg-white divide-y divide-gray-200 dark:divide-gray-700 dark:bg-gray-900">
                                            {
                                                eventData?.map((event:any) => {
                                                    return (
                                                        <tr key={event} className={event.players === event.playerLimit ? 'bg-emerald-900' : ''}>
                                                            <td className="px-4 py-4 text-sm text-gray-500 dark:text-gray-300 whitespace-nowrap">
                                                                <div className="flex items-center gap-x-2">
                                                                    <div>
                                                                        <h2 className="text-sm font-medium text-gray-800 dark:text-white ">{event.name}</h2>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                            ...
                                                            <td className="px-4 py-4 text-sm font-medium text-gray-700 dark:text-gray-200 whitespace-nowrap">
                                                                <div className="inline-flex items-center gap-x-3">
                                                                    <h2 className="text-sm font-medium text-gray-800 dark:text-white ">{event.playerLimit ? event.playerLimit : 'Tiada'}</h2>
                                                                </div>
                                                            </td>
